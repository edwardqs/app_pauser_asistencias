...
BEGIN
    ...
    ELSIF p_type = 'OUT' THEN
        ...
        IF v_existing_record.record_type = 'AUSENCIA' OR v_existing_record.record_type = 'INASISTENCIA' THEN
    ...
    ELSIF p_type = 'ABSENCE' THEN
        ...
        INSERT INTO public.attendance (
            ...
            record_type,
            created_at,
            location_in -- Guardamos ubicación del reporte
        ) VALUES (
            p_employee_id,
            v_today,
            ...
            p_evidence_url,
            'AUSENCIA', -- ACTUALIZADO: Nuevo estándar
            v_now_utc,
            jsonb_build_object('lat', p_lat, 'lng', p_lng) -- ACTUALIZADO: Guardar ubicación
        ) RETURNING id INTO v_attendance_id;
