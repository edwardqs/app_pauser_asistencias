-- SCRIPT DE POBLADO DE DATOS (SEED) - JERARQUÍA CORRECTA V7
...
INSERT INTO public.employees (
    full_name, dni, app_password, sede, business_unit, role, position, employee_type
) VALUES (
    'RICARDO JEFE', '10000001', '123456', 'LIMA', 'COMERCIAL', 
    'JEFE_VENTAS', 'Jefe Nacional de Ventas', 'Planilla'
);

-- 2. SUPERVISOR DE VENTAS (Reporta a Jefe de Ventas)
INSERT INTO public.employees (
    full_name, dni, app_password, sede, business_unit, role, position, employee_type, supervisor_id
) VALUES (
    'ROBERTO SUPERVENTAS', '20000002', '123456', 'TRUJILLO', 'SNACKS', 
    'SUPERVISOR_VENTAS', 'Supervisor Regional', 'Planilla',
    (SELECT id FROM public.employees WHERE dni = '10000001') -- Reporta a Ricardo
);
...
INSERT INTO public.employees (
    ...
    (SELECT id FROM public.employees WHERE dni = '20000002') -- Reporta a Roberto
);
...
INSERT INTO public.employees (
    ...
    'SUPERVISOR_OPERACIONES', 'Jefe de Centro Distribución', 'Planilla'
);
...
INSERT INTO public.employees (
    ...
    (SELECT id FROM public.employees WHERE dni = '40000004') -- Reporta a Oscar
);
...
INSERT INTO public.employees (
    ...
    (SELECT id FROM public.employees WHERE dni = '50000005') -- Reporta a Carlos
);
